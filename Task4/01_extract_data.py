...
def collect_drug_data(drug_name, max_records=500):
    ...
    while len(all_records) < max_records:
        try:
            ...
            headers = {
                'User-Agent': 'task4-severity-prediction-collector/1.0 (NYU-CDS-Capstone)'
            }
...
def main():
    ...
    for i, drug in enumerate(ONCOLOGY_DRUGS, 1):
        ...
        try:
            ...
            if i % 10 == 0:
                ...
                temp_file = f'task4_data_temp_{i}.csv'
    ...
    # Save summary report
    with open("task4_collection_summary.txt", "w") as f:
        f.write("=" * 80 + "\n")
    ...
    print("Saved summary: task4_collection_summary.txt")
    print()
