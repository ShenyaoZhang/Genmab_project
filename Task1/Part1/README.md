...
### Important: Unzip JADER Data First

Before running the pipeline, unzip the JADER database file:
...
This will extract the JADER (Japanese Adverse Drug Event Report) data required for multi-source analysis.
...
# 3. Unzip JADER data (required)
cd ..  # Go to Task1 folder
unzip jader_data.zip
cd Part1
