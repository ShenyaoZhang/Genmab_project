...
def run_data_extraction():
    ...
    if not os.path.exists("multi_source_crs_data.json"):
        print("\nCreating multi-source dataset (with simulated EU/JP data)...")
        from data_extractors import create_simulated_multi_source_data
        create_simulated_multi_source_data()
    else:
        print("Multi-source data already exists: multi_source_crs_data.json")
